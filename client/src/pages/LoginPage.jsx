...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex animate-fade-up">
      {/* Left Branding Panel */}
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-800 p-12 relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-64 h-64 bg-white rounded-full blur-3xl animate-float-soft" />
          <div className="absolute bottom-20 right-20 w-48 h-48 bg-emerald-300 rounded-full blur-3xl animate-float-soft" />
        </div>
        ...
        <div className="relative z-10">
          <blockquote className="text-white text-2xl font-bold leading-snug mb-6 max-w-xl">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <div key={f.title} className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-white/15 flex items-center justify-center text-lg shrink-0 backdrop-blur-sm">{f.icon}</div>
                <div>
      ...
      {/* Right Form Panel */}
      <div className="flex-1 flex items-center justify-center p-6 md:p-8 bg-gradient-to-br from-slate-50 via-white to-teal-50">
